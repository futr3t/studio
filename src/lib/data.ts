...
// Make mock data mutable for in-memory API simulation
export let mockSuppliersData: Supplier[] = [
...
export let mockAppliancesData: Appliance[] = [
...
export let mockProductionLogsData: ProductionLog[] = [
  {
    id: 'prod1',
...
export let mockDeliveryLogsData: DeliveryLog[] = [
  {
    id: 'del1',
    supplierId: 'sup1',
...
export let mockTemperatureLogsData: TemperatureLog[] = [
  {
    id: 'temp1',
    applianceId: 'app1',
    temperature: 3,
...
export let mockCleaningTasksData: CleaningTask[] = [
...
export let mockCleaningChecklistItemsData: CleaningChecklistItem[] = mockCleaningTasksData.map((task, index) => ({
  id: `item-${task.id}`,
  taskId: task.id,
  name: task.name,
  area: task.area,
