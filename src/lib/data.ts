...
// Mock users data needs to be defined before it's used in production logs
...
export const mockProductionLogsData: ProductionLog[] = [
  {
    ...
    isCompliant: true,
    verifiedBy: 'user1', // Alice Wonderland (was Chef Ramsay)
  },
  {
    id: 'prod2',
    ...
    verifiedBy: 'user2', // Bob The Builder (was Sous Chef Julia)
  },
];
...
export const mockDeliveryLogsData: DeliveryLog[] = [
  {
    ...
    isCompliant: true,
    receivedBy: 'Store Manager Bob', // This could also be a user ID in a more integrated system
  },
  {
    id: 'del2',
    supplierId: 'sup2',
...
// MockUsersData already defined above
